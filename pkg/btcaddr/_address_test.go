...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		// Positive P2PKH tests.
		{
			...
			f: func() (Address, error) {
				...
				return NewPubKeyHash(pkHash, &chaincfg.MainNetParams)
			},
		...
		},
		{
			...
			f: func() (Address, error) {
				...
				return NewPubKeyHash(pkHash, &chaincfg.TestNet3Params)
			},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (Address, error) {
				...
				return NewScriptHash(script, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
			...
			f: func() (Address, error) {
				...
				return NewScriptHashFromHash(hash, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
			...
			f: func() (Address, error) {
				...
				return NewScriptHashFromHash(hash, &chaincfg.TestNet3Params)
			},
			net: &chaincfg.TestNet3Params,
		},
		// Negative P2SH tests.
		...
		// Positive P2PK tests.
		{
			...
			f: func() (Address, error) {
				...
				return NewPubKey(serializedPubKey, &chaincfg.MainNetParams)
			},
			net: &chaincfg.MainNetParams,
		},
		{
		...
		},
		{
			...
			f: func() (Address, error) {
				...
				return NewPubKey(serializedPubKey, &chaincfg.TestNet3Params)
			},
			net: &chaincfg.TestNet3Params,
		},
		{
	...
	for _, test := range tests {
		...
		decoded, e := Decode(test.addr, test.net)
		if (e == nil) != test.valid {
